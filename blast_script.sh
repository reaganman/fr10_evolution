...
for genome in /scratch/general/nfs1/utu_4310/fr10_evolution_wd/fnas_dbs/*.fna; do blastn -query  /uufs/chpc.utah.edu/common/home/u6052680/fr10_evolution/fr10.fasta -db "$genome.db" -evalue 0.001 -outfmt "6 stitle qseqid sseqid evalue sseq" -out "$genome.db.results.txt"
done
